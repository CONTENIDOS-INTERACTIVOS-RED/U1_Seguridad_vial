        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad “Fundamentos de la seguridad vial laboral” aborda la importancia de garantizar entornos laborales seguros mediante una gestión efectiva de la movilidad. Se analizan conceptos claves, estadísticas de accidentalidad, el marco legal colombiano (como la Ley 769 del 2002 y la Ley 2251 del 2022) y guías internacionales como la norma ISO 39001. Se promueve una cultura de prevención, educación y cumplimiento normativo. También se resalta la relevancia de los Planes Estratégicos de Seguridad Vial (PESV), para reducir riesgos, fomentar comportamientos seguros y mejorar la infraestructura vial en las organizaciones.
